 ...
 */
package org.tadpoleweibo.graphic.drawable;
 ...
 */
public class PressStateDrawable extends BitmapDrawable {
     ...
     * @deprecated Use {@link PressStateDrawable#ActionBarDrawable(Context, int)}
     *             as it looks for the default alternative/normal colors in the
     *             theme.
     */
    @Deprecated
    public PressStateDrawable(Resources res, int resId) {
     ...
     * @deprecated Use
     *             {@link PressStateDrawable#ActionBarDrawable(Context, Drawable)}
     *             as it looks for the default alternative/normal colors in the
     *             theme.
     */
    @Deprecated
    public PressStateDrawable(Resources res, Drawable d) {
     ...
     * @deprecated Use
     *             {@link PressStateDrawable#ActionBarDrawable(Context, int, int, int)}
     *             as it looks for the default alternative/normal colors in the
     *             theme.
     */
    @Deprecated
    public PressStateDrawable(Resources res, int resId, int normalColor, int altColor) {
     ...
     * @param altColor The color used to color the icon in alternative mode
     * @deprecated Use
     *             {@link PressStateDrawable#ActionBarDrawable(Context, Drawable, int, int)}
     *             as it looks for the default alternative/normal colors in the
     *             theme.
     */
    @Deprecated
    public PressStateDrawable(Resources res, Drawable d, int normalColor, int altColor) {
        // TODO Cyril: Remove this constructor or the similar Context-based one.
        // They are actually the same ...
     ...
     */
    public PressStateDrawable(Context context, int resId) {
     ...
     */
    public PressStateDrawable(Context context, Drawable d) {
        // TODO Cyril: Should use a Bitmap instead of a Drawable ...
        this(context, d, Color.WHITE, Color.BLACK);
    }
     ...
     * @param altColor The color used to color the icon in alternative mode
     */
    public PressStateDrawable(Context context, int resId, int normalColor, int altColor) {
     ...
     * @param altColor The color used to color the icon in alternative mode
     */
    public PressStateDrawable(Context context, Drawable d, int normalColor, int altColor) {
        // TODO Cyril: Should use a Bitmap instead of a Drawable ...
