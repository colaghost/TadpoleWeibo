...
//
//    protected void fetchWeiboListPreferCache(final int uid) {
//        final SubscriptionActivity me = this;
//        new Thread(new Runnable() {
//            public void run() {
//                boolean hasCache = false;
//                FriendsCacheMgr localFriendsCacheMgr = new FriendsCacheMgr(me, uid);
//                try {
//                    PageList<User> pageList = localFriendsCacheMgr.getFriendsFromCache();
...
//                try {
//                    final PageList pageList = new FriendsCacheMgr(SubscriptionActivity.this.getApplicationContext(), XTZApplication.curUid).saveAndGetFriends(response);
