...
public class Emotion {
     ...
     * @throws Exception
     */
    public static ArrayList<Emotion> getEmotionsFromRemote(EMOTION_TYPE type, LANGUAGE language)
            throws Exception {
        String resp = XTZApplication.getStatusesAPI().emotions(type, language);
        return fromEmotionsResponse(resp);
    }

    public static ArrayList<Emotion> fromEmotionsResponse(String response) throws Exception {
